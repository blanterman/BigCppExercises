...
public:
	...
	*/
	Monthly(std::string desc, int year, int month, int day, int time);
	/**
	...
	*/
	...
	/**
		Outputs the monthly appointment information to a file
		param out dereference output stream
	*/
	virtual void save(std::ostream& out);
	/**
		Creates a monthly appointment using the information in the file
