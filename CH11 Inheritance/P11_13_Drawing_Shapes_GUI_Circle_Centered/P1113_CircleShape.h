...
public:
	/**
		Constructs an (equilateral) CircleShape object with no location
	*/
	CircleShape();
	/**
		Constructs an (equilateral) CircleShape object with radius and location
		@param loc Point location of center
		@param b radius length
	*/
	CircleShape(Point loc, double r);
	/**
		Returns Area of the CircleShape object
		@return area of CircleShape
	*/
	virtual double get_area() const;
	/**
		Plots the CircleShape on the xy plane
	*/
	virtual void plot();
private:
	double radius;
