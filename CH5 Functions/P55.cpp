// P55.cpp : Defines the entry point for the console application.
//
...
/**
	Turns a number ito its English name.
	@param n a positive integer -100,000,000 < n < 100,000,000
