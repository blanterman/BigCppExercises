...
/* Exercise P8.3. Write a test harness that automatically generates test cases 
for the arcsin function, namely numbers between -1 and 1 in a step size of 0.1
*/
